...
model_name = 'mnist_resnet101_model' # should update this value by each model
...
model =  tf.keras.applications.resnet.ResNet101(input_tensor=upsampled, weights=None, classes=n_classes)
