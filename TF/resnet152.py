...
model_name = 'mnist_resnet152_model' # should update this value by each model
...
model =  tf.keras.applications.resnet.ResNet152(input_tensor=upsampled, weights=None, classes=n_classes)
